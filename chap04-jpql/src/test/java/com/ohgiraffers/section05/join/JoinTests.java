...
public class JoinTests {
    ...
    /*
    * 조인의 종류
    * 1. 일반조인 : 일반적인 sql 조인을 의미(내부조인, 외부조인, 컬렉션 조인 , 세타조인)
    * 2. 페치조인 : jpql에서 성능 최적화를 위해 제공하는 기능으로 연관된 엔티티나 컬렉션을 한 번에 조회할 수 있다.
    ...
    * */
    ...
    public  void 세타조인을_이용한_조회_테스트(){
        // 세타 조인은 조인 되는 모든 경우의 수를 다반환하는 크로스 조인과 같다.
        // 엔티티들에 대한 조인을 말함
    ...
    public void 페치조인을_이용한_조회_테스트(){
        // 페치 조인을 하면 처음 spl 실행 후 로딩할떄 결과를 다 조회한 뒤에 사용하는 방식이기 때문에 쿼리 실행 횟수가 줄어들게된다.
        // 대부분의 경우 성능이 향상된다.
