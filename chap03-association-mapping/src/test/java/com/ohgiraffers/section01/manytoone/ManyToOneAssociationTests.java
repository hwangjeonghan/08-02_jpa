...
//        System.out.println("menuCategory : " + menuCategory);
    ...
    @Test
    public void 다대일_연관관계_객체지향_쿼리를_사용한_카테고리_이름_죄회_테스트(){
        // from의 테이블 명은 엔티티명이 되어야한다.
    ...
    * cascade-casscadetype.persist를 설정하면 menuandcdategory 엔티티를 영속화 할때 catrgroy 엔티티도 함께 영속화한다.
    * */
