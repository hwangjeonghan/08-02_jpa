...
public class BiDirectionTests {
    ...
    public void 양방향_연관관계_매핑_조회_테스트(){
        ...
        Menu foundMenu = entityManager.find(Menu.class, menuCdoe);
        Category foundCategory = entityManager.find(Category.class, categoryCode);
        Assertions.assertEquals(menuCdoe, foundMenu.getMenuCode());
    ...
    @Test
    void 양방향_연관관계_주인_객체를_이영한_삽입_테스트(){
        Menu menu = new Menu();
    ...
    @Test
    public void  양뱡향_연관관계_주인이_아닌_객체를_이용한_삽입테스트(){
